...
const Projects = () => {
  ...
  return project ? (
    <div className='flex flex-col h-screen w-full bg-gray-900 text-white'>
      ...
      <div className='hidden sm:flex gap-2 bg-gray-950 p-1.5 rounded-md'>
        ...
        <Laptop2Icon onClick={()=> setDevice('desktop')}  className={`size-6 p-1 rounded cursor-pointer ${device === 'desktop' ? "bg-gray-700" : ""}`}/>
      </div>
  ...
  (
    <div className='flex items-center justify-center h-screen'>
      <p className='text-2xl font-medium text-gray-300'>Unable to load projects!</p>
